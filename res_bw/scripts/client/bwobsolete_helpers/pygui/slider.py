# 2016.10.11 22:16:59 Støední Evropa (letní èas)
...
class Slider(PyGUIBase, VisualStateComponent):
    ...
    def create(texture, thumbTexture = '', isHorizontal = True, **kwargs):
        ...
        return s.component
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\bwobsolete_helpers\pygui\slider.pyc 
