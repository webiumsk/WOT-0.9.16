# 2016.10.11 22:16:53 Støední Evropa (letní èas)
...
class TeleportProgressBar(ChunkLoadingProgressBar):
    ...
    def onBlurred(self, callbackFn):
        ...
        if callbackFn:
            callbackFn()
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\bwobsolete_helpers\progressbar.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:16:54 Støední Evropa (letní èas)
