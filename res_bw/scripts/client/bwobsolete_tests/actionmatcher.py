...
def testSSO(entity = None):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res_bw\scripts\client\bwobsolete_tests\actionmatcher.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:17:02 Støední Evropa (letní èas)
