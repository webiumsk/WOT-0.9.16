# 2016.10.11 22:14:55 Støední Evropa (letní èas)
...
class ContactsListPopover(ContactsListPopoverMeta, ContactsCMListener):
    ...
    def __onSettingsChanged(self, diff):
        ...
        if isChanged and tree:
            tree.showContacts(onlineMode=onlineMode, showVisibleOthers=showOthers, showEmptyGroups=True)
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\messenger\gui\scaleform\view\lobby\contactslistpopover.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:14:56 Støední Evropa (letní èas)
