# 2016.10.11 22:09:18 Støední Evropa (letní èas)
...
def overridePlay(self, fileName = None):
    ...
    return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\development\replay_override\battlereplaypatch.pyc 
