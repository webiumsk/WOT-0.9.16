# 2016.10.11 22:13:39 Støední Evropa (letní èas)
...
def packVehicleLevelsFilter(levelRange = range(MIN_VEHICLE_LEVEL, MAX_VEHICLE_LEVEL + 1)):
    ...
    return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\shared\formatters\vehicle_filters.pyc 
