# 2016.10.11 22:10:47 Støední Evropa (letní èas)
...
class EquipmentsPlugin(common.IntervalPlugin):
    ...
    def __onEquipmentMarkerShown(self, equipment, position, _, interval):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\battle\shared\minimap\plugins.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:10:48 Støední Evropa (letní èas)
