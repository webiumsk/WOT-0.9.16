# 2016.10.11 22:10:42 Støední Evropa (letní èas)
...
class PostmortemPanel(_SummaryPostmortemPanel):
    ...
    def __onSettingsChanged(self, diff):
        if GRAPHICS.COLOR_BLIND in diff:
            ...
            self.__deathAlreadySet = False
            self.__updateVehicleInfo()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\battle\shared\postmortem_panel.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:10:43 Støední Evropa (letní èas)
