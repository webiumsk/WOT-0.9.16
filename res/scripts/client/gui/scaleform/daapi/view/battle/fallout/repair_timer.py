# 2016.10.11 22:10:37 Støední Evropa (letní èas)
...
class RepairPointTimer(RepairPointTimerMeta):
    ...
    def __onRepairPointVehicleLeft(self, pointIndex, stateID):
        self.__hideTimer()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\battle\fallout\repair_timer.pyc 
