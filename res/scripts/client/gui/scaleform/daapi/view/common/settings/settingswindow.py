# 2016.10.11 22:10:50 Støední Evropa (letní èas)
...
class SettingsWindow(SettingsWindowMeta):
    ...
    def __isGraphicsPresetApplied(self, settings):
        ...
        return True
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\common\settings\settingswindow.pyc 
