# 2016.10.11 22:10:51 Støední Evropa (letní èas)
...
class ConfirmBoosterDialog(ConfirmItemWindowMeta):
    ...
    def __makeBoosterVO(booster):
        return {'boosterId': booster.boosterID,
         ...
         'isInactive': True}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\dialogs\confirmboosterdialog.pyc 
