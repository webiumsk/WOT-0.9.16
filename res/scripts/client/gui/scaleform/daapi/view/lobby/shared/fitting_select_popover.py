# 2016.10.11 22:12:01 Støední Evropa (letní èas)
...
class _PreviewLogicProvider(_PopoverLogicProvider):
    ...
    def _buildModuleData(self, module, isInstalled, _):
        ...
        moduleData.update({'targetVisible': isInstalled,
         ...
         'disabled': reason == ''})
        return moduleData
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\shared\fitting_select_popover.pyc 
