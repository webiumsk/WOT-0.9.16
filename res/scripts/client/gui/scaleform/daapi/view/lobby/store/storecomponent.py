# 2016.10.11 22:12:02 Støední Evropa (letní èas)
...
class StoreComponent(LobbySubView, StoreComponentMeta):
    ...
    def __onVehCompareBasketSwitchChange(self):
        ...
        """
        self._update()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\scaleform\daapi\view\lobby\store\storecomponent.pyc 
