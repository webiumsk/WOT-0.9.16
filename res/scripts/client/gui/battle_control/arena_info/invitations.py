# 2016.10.11 22:09:29 Støední Evropa (letní èas)
...
def createInvitationsHandler(setup):
    ...
    return handler
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\arena_info\invitations.pyc 
