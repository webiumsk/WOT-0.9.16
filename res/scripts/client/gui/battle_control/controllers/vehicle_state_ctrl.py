# 2016.10.11 22:09:36 Støední Evropa (letní èas)
...
def createCtrl(setup):
    ...
    return ctrl
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\controllers\vehicle_state_ctrl.pyc 
