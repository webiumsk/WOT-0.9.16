# 2016.10.11 22:09:31 Støední Evropa (letní èas)
    ...
    def __getCurrentVehicleDesc(self, player):
        ...
        for vID, desc in vehicles.items():
            if vID == player.playerVehicleID:
                return desc
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\controllers\chat_cmd_ctrl.pyc 
