# 2016.10.11 22:09:35 Støední Evropa (letní èas)
...
class FalloutControllersRepository(_ControllersRepositoryByBonuses):
    ...
    def create(cls, setup):
        ...
        repository.addViewController(debug_ctrl.DebugController(), setup)
        return repository
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\controllers\repositories.pyc 
