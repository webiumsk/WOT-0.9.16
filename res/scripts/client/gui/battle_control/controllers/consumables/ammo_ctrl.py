# 2016.10.11 22:09:37 Støední Evropa (letní èas)
...
class AmmoReplayPlayer(AmmoController):
    ...
    def __onAmmoSettingChanged(self, idx):
        if idx >= len(self._order) or idx < 0:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\battle_control\controllers\consumables\ammo_ctrl.pyc 
