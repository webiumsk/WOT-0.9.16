# 2016.10.11 22:10:01 Støední Evropa (letní èas)
...
class ScreenCastController(Controller, IArenaVehiclesController):
    ...
    def __update(self):
        ...
        if self._dbID != 0 and not self._isSet:
            ...
            self._isSet = True
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\game_control\screencast_controller.pyc 
