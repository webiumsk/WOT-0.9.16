# 2016.10.11 22:10:27 Støední Evropa (letní èas)
...
class PrbStorageDecorator(LocalStorage):
    ...
    def clear(self):
        for storage in self.__readonly__.itervalues():
            storage.clear()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\gui\prb_control\storage\__init__.pyc 
