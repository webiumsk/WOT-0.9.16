# 2016.10.11 22:08:55 Støední Evropa (letní èas)
...
class ClientRecycleBin(object):
    ...
    def __onGetItemsResponse(self, itemsType, callback, resultID):
        if resultID < 0:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\scripts\client\account_helpers\client_recycle_bin.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2016.10.11 22:08:56 Støední Evropa (letní èas)
